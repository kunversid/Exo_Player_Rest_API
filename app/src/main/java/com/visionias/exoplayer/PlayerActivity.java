...
public class PlayerActivity extends AppCompatActivity
    ...
    public static final String ABR_ALGORITHM_DEFAULT = "VideoURL";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String sphericalStereoMode = intent.getStringExtra("VideoURL");
...
//            mediaSource = createTopLevelMediaSource(intent);
            ...
            String abrAlgorithm = intent.getStringExtra("VideoURL");
